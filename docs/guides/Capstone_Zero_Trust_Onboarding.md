...
```
   ...
   request ──▶ agent ──┤  1. SCIM: create identity      → SAML/SCIM IdP          │
...
|---|---|---|
| **1. Identity** | [Identity Provisioning Agent (SCIM)](Identity_Provisioning_SCIM_Agent_Guide.md) | Agent extracts name/email and provisions Jane in the SAML/SCIM IdP (`POST /scim/v2/Users`), placing her in a `contractors` group. |

...
- **[Identity Provisioning Agent (SCIM)](docs/guides/Identity_Provisioning_SCIM_Agent_Guide.md)**: An agent that onboards a person into KhalIDP — the Identity Provider simulator — from plain language — the identity side of Zero Trust, paired with the [KhalIDP](https://github.com/alshawwaf/SAML_IDP_Simulator).
